...
import com.example.imms.web.dao.BaseAdminPermissionMapper;
import com.example.imms.web.dao.BaseAdminRoleMapper;
...
public class AdminRoleServiceImpl implements AdminRoleService {
    ...
    @Autowired
    public BaseAdminRoleMapper baseAdminRoleMapper;

    @SuppressWarnings("SpringJavaInjectionPointsAutowiringInspection")
    @Autowired
    public BaseAdminPermissionMapper baseAdminPermission;
    ...
    public PageDataResult getRoleList(Integer pageNum, Integer pageSize) {
        ...
        for(BaseAdminRole r:roles){
            ...
            if(!StringUtils.isEmpty(permissions)){
                ...
                for(String id: ids){
                    BaseAdminPermission baseAdminPermission = this.baseAdminPermission.selectByPrimaryKey(Integer.valueOf(id));
    ...
    public Map<String,Object> addRole(BaseAdminRole role) {
        ...
        try {
            ...
            int result = baseAdminRoleMapper.insertRole(role);
            if(result == 0){
                data.put("code",0);
                data.put("msg","新增角色失败");
                logger.error("新增角色失败");
